...
Example from [quarto
documentation](https://quarto.org/docs/computations/r.html#code-blocks)
...
3.  Use `.github/workflows/render-and-publish-with-code.yml` as your
    ...
    -   Comment out the first three lines, save and close that workflow
    -   From your repository, open
        [`.github/workflows/render-and-publish-with-code.yml`](https://github.com/SAEL-SWFSC/PAM_template_ResearchCompendium/blob/main/.github/workflows/render-and-publish-with-code.yml)
    -   Uncomment lines 4-6, save and close workflow
4.  Save and push all changes to GitHub, make sure the new `renv` files
    are pushed.
